...
const AppointmentForm = () => {
  ...
  const onFinish = (personalDetail) => {
    if (
      ...
      personalDetail.number == undefined ||
      personalDetail.mail === undefined ||
      personalDetail.address === undefined
    ) {
      {
    ...
    <section className={styles.formContainer} id="form">
      <div>
        ...
        <div className={styles.formHeader}>
          <h3>
            Make an appointment <br /> with a doctor
          </h3>
          <div>
            <Form
              name="personalDetail"
            ...
            >
              ...
              <Modal title="Appointment Form" open={state.visible} onOk={() => setState(!state.visible)}>
                <p>Your already booked the appointment</p>
              </Modal>
              <Modal title="Appointment Form" open={empty.visible} onOk={() => setempty(!empty.visible)}>
                <p>First fill the form</p>
              </Modal>
              <Modal title="Appointment Form" open={booked.visible} onOk={() => setBooked(!booked.visible)}>
